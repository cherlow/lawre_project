            ...
            <div class="page-sidebar">
                ...
                <div class="sidebar custom-scrollbar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="sidebar-header" href="{{url('/sellerproducts')}}"><i
                                    data-feather="box"></i><span>Products</span></a></li>
                        <li><a class="sidebar-header" href="{{url('/bids')}}"><i
                                    data-feather="tag"></i><span>Bids</span></a></li>
                        ...
                        <li><a class="sidebar-header" href="{{url('/selleraddproducts')}}"><i
                                    data-feather="log-in"></i><span>New Product</span></a>
                        </li>
